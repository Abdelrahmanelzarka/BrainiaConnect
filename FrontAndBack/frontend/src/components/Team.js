...
export default function Team() {
  ...
  return (
    ...
    <div class="column">
      <div class="card">
        <img src={zarka} alt="zarka" style={{width:"100%", height:"400px"}}/>
    ...
    <div class="column">
      <div class="card">
        <img src={nadeen} alt="nadeen" style={{width:"100%", height:"400px"}}/>
        <div class="container-team">
          <h2>Nadeen Medhat</h2>
          <p class="title">Student</p>
          <p>Software Engineer</p>
    ...
    <div class="column">
      <div class="card">
        <img src={kareem} alt="kareem"style={{width:"100%", height:"400px"}}/>
        <div class="container-team">
          <h2>Kareem Akram</h2>
          <p class="title">Student</p>
          <p>Software Engineer</p>
    ...
    <div class="column">
      <div class="card">
        <img src={haneen} alt="haneen" style={{width:"100%", height:"400px"}}/>
        <div class="container-team">
          <h2>Haneen Hossam</h2>
          <p class="title">Student</p>
          <p>Software Engineer</p>
    ...
    <div class="column">
      <div class="card">
        <img src={mayar} alt="Mayar" style={{width:"100%", height:"400px"}}/>
        <div class="container-team">
    ...
    <div class="column">
      <div class="card">
        <img src={inzo} alt="inzo" style={{width:"100%", height:"400px"}}/>
        <div class="container-team">
          <h2>Abdelrahman Moustafa</h2>
          <p class="title">Student</p>
          <p>Software Engineer</p>
